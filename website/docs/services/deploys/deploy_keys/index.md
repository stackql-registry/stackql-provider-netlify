...
<tr><td><b>Id</b></td><td><CopyableCode code="netlify.deploys.deploy_keys" /></td></tr>
</tbody></table>
...
created_at,
public_key
FROM netlify.deploys.deploy_keys
...
```sql
INSERT INTO netlify.deploys.deploy_keys (
...
```sql
DELETE FROM netlify.deploys.deploy_keys
WHERE key_id = '{{ key_id }}' --required
;
```
</TabItem>
